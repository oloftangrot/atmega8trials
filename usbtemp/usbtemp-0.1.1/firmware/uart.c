...
/* I N T E R R U P T  B L O C K  P O L I C Y */
#ifndef BLOCK_POLICY
#define BLOCK_POLICY ISR_BLOCK // Do not allow INT0 exception even within other exception handlers.
#endif
/*
...
ISR( UART0_RECEIVE_INTERRUPT, BLOCK_POLICY )
/*************************************************************************
...
ISR( UART0_TRANSMIT_INTERRUPT, BLOCK_POLICY )
/*************************************************************************
...
ISR( UART1_RECEIVE_INTERRUPT, BLOCK_POLICY )
/*************************************************************************
...
ISR( UART1_TRANSMIT_INTERRUPT, BLOCK_POLICY )
/*************************************************************************
